    ...
    <div class="about">
        <div class="about__header">
            <div class="header__box1">
                ...
                <div class="header__title textTitle">Сильная команда <br> создает сильные <br> продукты</div>
            ...
            <div class="header__box2">
                ...
                <div class="box2__info">
                    <div class="infoWrapper textNormal">
                        <span class="textBold">Базис нашей студии основан на 4 принципах</span> которые являются нашими преимуществами и залогом успеха наших продуктов
                    </div>
                </div>
            </div>
        </div>
        ...
        class="about__footer">
            ...
            <div class="darkened">
            <img  class="about__bg" src="../assets/img/footer/aboutFooter.svg" alt="">
            </div>
